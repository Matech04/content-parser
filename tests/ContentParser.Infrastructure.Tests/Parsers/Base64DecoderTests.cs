...
public class Base64DecoderTests
{
    ...
    [InlineData("a")]          // dlugosc nie jest wielokrotnoscia 4
    [InlineData("****")]
    ...
    {
        // Poprawny Base64, ale zdekodowane bajty nie sa tekstem UTF-8.
        // Bez scislego dekodera trafilyby dalej jako U+FFFD i dalyby mylacy blad parsera.
    ...
    {
        // Limit dotyczy tresci PO zdekodowaniu, a nie dlugosci ciagu Base64 (ktory jest ~33% dluzszy).
